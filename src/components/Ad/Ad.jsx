      ...
      <div className="ad">
        <div className="container">
          <div className="ad__row">
            ...
            <a className="ad__link link-active " href="#">
              Арендовать
            </a>
          </div>
          <h2>Анонсировать</h2>
          ...
          <div className="ad__inputs">
            <div className="ad__input-1">
              <input placeholder="наименование товара" type="text" />
              <input placeholder="Категория продукта" type="text" />
            </div>
            <div className="ad__input-1">
              <input placeholder="Адрес продукта" type="text" />
              <input placeholder="Подробности" type="text" />
            </div>
            <div className="ad__input-3 comment">
            <textarea placeholder="О продукте"></textarea>
            </div>
